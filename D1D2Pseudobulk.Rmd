...
# changing condition names upon request from Nawid
...
pseudo_bulk_rna <- function(fit, effect, markers){
  ...
  p4 <- plotDots(sce, features=down, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
  up <- effect.rna[[1]]$label[effect.rna[[1]]$significance == "UP"]
  up <- up[!is.na(up)]
  p5 <- plotDots(sce, features=up, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) + 
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
pseudo_bulk_adt <- function(fit, effect, effect.coef, markers){
  ...
  down <- down[!is.na(down)]
  p4 <- plotDots(altExp(sce), features=down, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
  up <- effect.adt[[1]]$label[effect.adt[[1]]$significance == "UP"]
  up <- up[!is.na(up)]
  p5 <- plotDots(altExp(sce), features=up, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
pheatmap(coc_rna_df, cluster_cols = FALSE,
         ...
         angle_col = 45, width = 4, height = 4, filename = "rna.heatmap.png")
```
...
pheatmap(coc_adt_df, cluster_cols = FALSE,
         color = myColor, breaks = myBreaks,
         angle_col = 45, width = 4, height = 3, filename = "adt.heatmap.png")
```
...
p
ggsave("plot9.png", p, height = 3, width = 3)
...
pseudo_bulk_rna <- function(fit, effect, markers){
  ...
  down <- effect.rna[[1]]$label[effect.rna[[1]]$significance == "DOWN"]
  down <- down[!is.na(down)]
  p4 <- plotDots(sce_before_split, features=down, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
  up <- effect.rna[[1]]$label[effect.rna[[1]]$significance == "UP"]
  up <- up[!is.na(up)]
  p5 <- plotDots(sce_before_split, features=up, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) + 
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
```{r, fig.width=10, fig.height=5}
p2 <- plot_grid(car_effect_rna_before[[5]] , car_effect_rna_before[[6]], ncol = 2, align = "hv")
p2
```
...
```{r, fig.width=10, fig.height=5}
p4 <- plot_grid(ko_effect_rna_before[[5]], ko_effect_rna_before[[6]], ncol = 2, align = "hv")
p4
```
...
```{r, fig.width=10, fig.height=5}
p6 <- plot_grid(carko_effect_rna_before[[5]], carko_effect_rna_before[[6]], ncol = 2, align = "hv")
p6
```
...
pseudo_bulk_adt <- function(fit, effect, effect.coef, markers){
  ...
  down <- effect.adt[[1]]$label[effect.adt[[1]]$significance == "DOWN"]
  down <- down[!is.na(down)]
  p4 <- plotDots(altExp(sce_before_split), features=down, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
  up <- effect.adt[[1]]$label[effect.adt[[1]]$significance == "UP"]
  up <- up[!is.na(up)]
  p5 <- plotDots(altExp(sce_before_split), features=up, group="condition", color = c("grey", "orange", "red", "darkred", "blue")) +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
p8 <- plot_grid(car_effect_adt_before[[5]] + theme(axis.text.y = element_text(size = 10)), car_effect_adt_before[[6]] + theme(axis.text.y = element_text(size = 10)), ncol = 2, align = "hv")
p8
```
...
p0 <- volcano.sig.adt(carko_tags[[1]])
p0
```
