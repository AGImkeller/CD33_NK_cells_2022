...
pheatmap(coc_rna_df, cluster_cols = FALSE,
         color = myColor, breaks = myBreaks,
         angle_col = 45, width = 4, height = 3, filename = "fig5g.tiff")

pheatmap(coc_rna_df, cluster_cols = FALSE,
         color = myColor, breaks = myBreaks,
         angle_col = 45, width = 4, height = 3, filename = "fig5g.pdf")
```
...
pheatmap(coc_rna_df, cluster_cols = FALSE,
         color = myColor, breaks = myBreaks,
         angle_col = 45, width = 4, height = 3, filename = "fig5g.D1.tiff")

pheatmap(coc_rna_df, cluster_cols = FALSE,
         color = myColor, breaks = myBreaks,
         angle_col = 45, width = 4, height = 3, filename = "fig5g.D1.pdf")
```
...
p <- list(mds.plot@.Data[[9]], mds.plot@.Data[[10]]) %>%
  ...
  geom_point(size = 2) + 
  geom_label_repel(aes(label = SampleID), size = 3, box.padding = 0.75) + 
  theme_bw() + 
  scale_color_manual(values = c("#f2b77d", "#ff8080", "#90bff9", "#a0a0a3")) + 
  theme(legend.position = "none") +
  xlab("Leading logFC dim 1 (63%)") + ylab("Leading logFC dim 2 (20%)")
p
ggsave("fig3b.tiff", p, height = 4, width = 4)
ggsave("fig3b.pdf", p, height = 4, width = 4)
