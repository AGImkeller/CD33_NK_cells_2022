...
ct <- read.csv(paste(data.dir, "Combined_CARNK_Sample2_cell_type_experimental.csv", sep = ""))
ct$Cell_Index <- paste(ct$Cell_Index, "_D2", sep = "")

## joining both metadata
coldata <- left_join(coldata, ct, by = "Cell_Index")
```
